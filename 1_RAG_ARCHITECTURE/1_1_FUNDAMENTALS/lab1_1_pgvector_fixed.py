"""
lab1_1_pgvector_fixed.py
==========================
Version 2 of 2 (pgvector). Sentence-aware chunking + PostgreSQL/pgvector.
"""
...
if __name__ == "__main__":
    ...
    with conn.cursor() as cur:
        ...
        cur.execute("DROP TABLE IF EXISTS lab1_1_fixed_chunks;")
        cur.execute(f"""
            CREATE TABLE lab1_1_fixed_chunks (
    ...
    with conn.cursor() as cur:
        for text, emb in zip(chunks, embeddings):
            cur.execute(
                "INSERT INTO lab1_1_fixed_chunks (chunk_text, embedding) VALUES (%s, %s)",
                (text, emb),
            )
    conn.commit()
